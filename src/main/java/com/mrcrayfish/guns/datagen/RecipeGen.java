...
public class RecipeGen extends RecipeProvider
{
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer)
    {
        ...
        WorkbenchRecipeBuilder.crafting(ModItems.BASIC_BULLET.get(), 64)
                .addIngredient(WorkbenchIngredient.of(Items.COPPER_INGOT, 5))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.GUNPOWDER, 4))
                .addIngredient(WorkbenchIngredient.of(Items.PAPER, 4))
        ...
        WorkbenchRecipeBuilder.crafting(ModItems.SHELL.get(), 64)
                ...
                .addCriterion("has_gunpowder", has(Tags.Items.GUNPOWDER))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ModItems.MISSILE.get(), 8)
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 30))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.GUNPOWDER, 30))
                .addCriterion("has_iron_ingot", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_gunpowder", has(Tags.Items.GUNPOWDER))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ModItems.GRENADE.get(), 10)
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 3))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.GUNPOWDER, 8))
                .addCriterion("has_iron_ingot", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_gunpowder", has(Tags.Items.GUNPOWDER))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ModItems.STUN_GRENADE.get(), 10)
                .addIngredient(WorkbenchIngredient.of(Tags.Items.INGOTS_IRON, 3))
                .addIngredient(WorkbenchIngredient.of(Tags.Items.GUNPOWDER, 8))
        ...
        WorkbenchRecipeBuilder.crafting(ModItems.MEDIUM_SCOPE.get())
                ...
                .addIngredient(WorkbenchIngredient.of(Tags.Items.DUSTS_REDSTONE, 40))
                .addCriterion("has_iron_ingot", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_amethyst", has(Tags.Items.GEMS_AMETHYST))
                .addCriterion("has_redstone", has(Tags.Items.DUSTS_REDSTONE))
                .build(consumer);
        WorkbenchRecipeBuilder.crafting(ModItems.LONG_SCOPE.get())
                ...
                .addIngredient(WorkbenchIngredient.of(Tags.Items.DYES_BLACK, 10))
                .addCriterion("has_iron_ingot", has(Tags.Items.INGOTS_IRON))
                .addCriterion("has_amethyst", has(Tags.Items.GEMS_AMETHYST))
        ...
        WorkbenchRecipeBuilder.crafting(Items.ENCHANTED_BOOK)
